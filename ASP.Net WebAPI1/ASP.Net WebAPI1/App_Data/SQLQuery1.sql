...
-- --------------------------------------------------
-- Date Created: 07/09/2018 10:58:09
...
IF OBJECT_ID(N'[dbo].[FK_PhoneComlection]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ComlectionSet] DROP CONSTRAINT [FK_PhoneComlection];
GO
...
GO
IF OBJECT_ID(N'[dbo].[ComlectionSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ComlectionSet];
GO
